...
public class GenerateZReportPanel extends JPanel {
    Controller controller;
    JButton generateZReportButton = new JButton("Generate Z report");
    ...
    GenerateZReportPanel(Controller controller) {
        this.controller = controller;
        setLayout(new BorderLayout());

        selection.add(generateZReportButton);

        add(selection, BorderLayout.NORTH);
        add(tableSlot, BorderLayout.CENTER);

        generateZReportButton.addActionListener(new ActionListener() {
    ...
    void generateSalesReportClicked() {
        ...
        List<List<String>> salesList = controller.generateZReport();
