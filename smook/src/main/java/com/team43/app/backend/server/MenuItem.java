...
public class MenuItem {
    ...
    private int countDummyItems() {
        return quantityInventoryItem("Dummy Item");
    }

    // Removes up to num_remove dummy items from the menu item
    // and returns actual number of dummy items removed
    ...
    // and returns actual number of items removed
